...
function () {
  ...
  FindFalconComponent.prototype.selectDestination = function (index, planetObj) {
    this.selectedItems[index].name = 'aa';
    this.selectedItems[index].distance = 'zz';
    this.selectedItems[index].imageUrl = 'qq';
  };

  FindFalconComponent = __decorate([core_1.Component({
